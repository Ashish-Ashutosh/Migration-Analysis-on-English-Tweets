...
fName = "outputfiles/dictionaryFileGBC.p"
#write binary mode
...
fName = "outputfiles/classifierGBC.p"
fObject=open(fName,'wb')
...
plot_confusion_matrix(cnf_matrix, classes=class_names,
                      title='Confusion matrix, without normalization GBC')

# Plot normalized confusion matrix
plt.figure()
plot_confusion_matrix(cnf_matrix, classes=class_names, normalize=True,
                      title='Normalized confusion matrix GBC')

...
print('Pickling out')
positive_data = np.load('ironic_semeval.npy')
negative_data = np.load('nonironic_semeval.npy')
...
#print('Number of ironic tweets :', len(neutral_data))


print('Feature engineering')
classificationSet = ['Positive', 'Negative', 'Neutral'] #label set
featureSets = []
...
print("printing feature sets ....")
print(featureSets)

featureSets=np.array(featureSets)
targets=(featureSets[0::,1]=='Positive').astype(int)
